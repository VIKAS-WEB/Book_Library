...
class AppColor{
  ...
  static  Color gradientFirst=const Color(0xff181717);
  static  Color gradientSecond=const Color(0xff656564);
  ...
  static Color secondPageContainerGradient1stColor= const Color(0xffdcc18a);
  static Color secondPageContainerGradient2ndColor= const Color(0xff5e5e5e);
  static Color secondPageIconColor= const Color(0xFFfafafe);
  static Color loopColor = const Color(0xfff8d47e);
  static Color setsColor = const Color(0xFFd8c898);
  ...
  static Color GreenC1 = const Color(0xff132613);
  static Color GreenC2 = const Color(0xffD2D2D2);
